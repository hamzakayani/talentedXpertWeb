...
const FilterCard: FC<any> = ({ promoted, setPromoted, setAmountType, resetFilters, search, setSearch, setRating, rating, minBudget, maxBudget, setMinBudget, setMaxBudget, amountType, setDisability, disability }: any) => {
