...
const Contract = ({ proposalId, taskId, taskStatus, isOpen, onClose, task }: any) => {
  ...
  const handleGenerateAI = async () => {
    setLoading(true);
    if (task?.details) {
      const response = await apiCall(requests.createContractDescription, { job_description: `${task?.details}` }, 'post', false, dispatch, null, null);
