...
// import CreateTalentExpertProfileModal from "../CreateTalentExpertProfileModal";
...
const Sidebar = () => {
  ...
  // const createTRAccount = () => {
  //   console.log("createTRAccount");
                ...
                {user?.profile?.length > 0 &&
                  user?.profile[0]?.type === "TE" && (
                    <Link
                      ...
                      onClick={() =>
                        navigate("/dashboard/payments/information")
                      }
                    >
                      <li
                        className={
