...
const nextConfig = {
    ...
    env:{
        ...
        NEXT_PUBLIC_LINKEDIN_APPID: process.env.NEXT_PUBLIC_LINKEDIN_APPID,
        NEXT_PUBLIC_LINKEDIN_SECRET_KEY: process.env.NEXT_PUBLIC_LINKEDIN_SECRET_KEY,
        NEXT_PUBLIC_GOOGLE_CLIENT_SECRET: process.env.NEXT_PUBLIC_GOOGLE_CLIENT_SECRET,
        NEXT_PUBLIC_GOOGLE_MAP_API_KEY: process.env.NEXT_PUBLIC_GOOGLE_MAP_API_KEY,
        NEXT_PUBLIC_VIDEOSDK_API_KEY: process.env.NEXT_PUBLIC_VIDEOSDK_API_KEY,
        NEXT_PUBLIC_VIDEOSDK_SECRET_KEY: process.env.NEXT_PUBLIC_VIDEOSDK_SECRET_KEY,
    },
    images: {
        remotePatterns: [
            {
