            ...
            <div className='card-bodyy my-active-task py-2 '>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-8'>
                        <div className='card bg-gray mt-3 me-3 p-3'>
                            <div className="ChatHead">
                                <li className="group">
                                    <div className="avatar"><img src="imgs/Asset 1.svg" alt="" /></div>
                                    <p className="GroupName">David Johnson</p>
                                </li>
                                <div className="callGroupicon">
                                    <Icon className='text-info m-1' icon="weui:search-outlined" />
                                    <Icon className='text-info m-1' icon="material-symbols-light:call-outline-sharp" />
                                    <Icon className='text-info m-1' icon="carbon:video" />
                                    <Icon className='text-info m-1' icon="mage:dots" />
