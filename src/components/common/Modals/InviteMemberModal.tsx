...
const InviteMemberModal: FC<{
  ...
  const fetchUsers = async () => {
    if (
      searchQuery.email &&
      !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(searchQuery.email)
    ) {
      setError("Invalid email format");
      return;
    }
    const hasQuery = Object.values(searchQuery).some(
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-3">
                  ...
                  <div className="col-md-6">
                    <div className="form-floating">
                      <select
                        id="categoryId"
                        name="categoryId"
                        className="form-select bg-transparent invert borderlightgray"
                ...
                <div className="text-end">
                  <button
                    type="button"
                    className="btn rounded-lg bg_gradient"
                    onClick={fetchUsers}
                    disabled={loading}
                  >
                ...
                <div className="mb-5">
                  ...
                  {errors.memberProfileId && (
                    <div className="text-danger pt-2">
                      {errors.memberProfileId.message}
                    </div>
                  )}
                </div>
              )}
              <div className="d-flex justify-content-between">
                <button
                  type="button"
                  className="btn btn-dark btn-sm rounded-lg me-2"
                  onClick={handleClose}
                >
                  Cancel
                </button>
