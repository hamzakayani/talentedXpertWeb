...
const SubmitReviewMilestone = ({setsubmitReviewMilestoneCheck, reviewMilestone, taskId, revieweeTeamId, getContract}:any) => {
...
//   const [comments, setComments] = useState(''); // Simple state for comments
  ...
  const {
    ...
    //   weeklyMilestoneId: Number(0),
      milestoneId: Number(reviewMilestone.id),
      reviewerProfileId: Number(user?.profile[0]?.id),
      revieweeProfileId: Number(reviewMilestone.teamMemberProfileId),
      revieweeTeamId:Number(revieweeTeamId)
    },
